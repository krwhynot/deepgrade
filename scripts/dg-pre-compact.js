#!/usr/bin/env node
// DeepGrade: PreCompact handler — lane N
//
// F26: exit-0 output must be JSON. dg-pre-compact.sh wrote a bare line to stdout,
...
// if it cannot, the compact-resume line moves to dg-session-start.js's
...
process.stdout.write(JSON.stringify({
  systemMessage: `[DeepGrade] Compacting. Active plan: ${latest.name} at phase: ${phase}. Resume with /deepgrade:plan ${latest.name}`,
}) + '\n');
process.exit(0);
