...
- `quick-plan.md` invokes the auditor and up to two revisions. Old user docs called it ungated or an eight-dimension review. Its instructions also claim parity with Stage 2, but do not explicitly orchestrate the canary and evidence tools. Document an audited draft, not a validated Stage 2 pass. Command changes are outside this rewrite.
