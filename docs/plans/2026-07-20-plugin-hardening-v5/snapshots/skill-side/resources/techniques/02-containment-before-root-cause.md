...
Is this SEV1 or SEV2?
  ...
  NO  → Skip to standard investigation (Phase 1 of core methodology)
```
...
- If yes: proceed to standard Phase 1 (Locate)
...
## Interaction with the Iron Law

The Iron Law in SKILL.md states: "NO PERMANENT FIXES WITHOUT ROOT-CAUSE INVESTIGATION FIRST." Containment is consistent with this — containment is NOT a permanent fix. It is a temporary mitigation that restores service while permanent investigation continues.

The modified Iron Law for SEV1/SEV2 incidents: *"No PERMANENT fixes without root cause investigation. Containment mitigations are allowed immediately for SEV1/SEV2."* Containment means: rollback, feature-flag disable, config revert, traffic shedding, failover. NOT refactors, NOT speculative code edits, NOT "ship a guess and move on."
