...
|-------|----------------------|--------|
| Phase 0: Triage (technique 01) | Severity classified as SEV1/SEV2 | Send initial notification |
| Containment (technique 02) | Containment applied or failed | Send containment status |
| Phase 1–3: Investigation | Root cause identified | Send update with cause and ETA |
| Phase 4: Fix | Fix deployed | Send resolution notification |
| Postmortem (technique 06) | Postmortem complete | Share with stakeholders |
...
## What This Technique Does NOT Include

This technique describes WHAT to send and WHEN. It does NOT integrate with Slack, PagerDuty, email, or any other channel. The destination project provides the channels. The protocol provides the structure for the messages.

For AI-assisted troubleshooting, generate DRAFT stakeholder updates that the user can copy/send manually. Do not attempt to send messages directly.
