...
| Git history | Any telemetry | Fall back to code-first approach (default method) |
| Nothing | Everything | Default approach is correct — read code, trace logic |
