...
Three plugins, one release, install any subset. This page is the decision.

## The one-line version

| You want to… | Install |
| --- | --- |
| Find out whether an AI agent can work in this codebase at all | `toque-readiness` |
| Get a severity-graded inventory of what is wrong with the code | `toque-audit` |
| Take a change from idea to release with gates at every step | `toque` |

## Longer

### `toque-readiness` — can an agent read this?
...
### `toque-audit` — what is wrong with the code?
