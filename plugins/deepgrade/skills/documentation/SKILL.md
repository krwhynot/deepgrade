...
| Security scan | `/deepgrade-audit:codebase-security` |
| Characterize | `/deepgrade-audit:codebase-characterize [module]` |
| Setup gates | `/deepgrade-audit:codebase-gates` |
| Generate artifacts | `/deepgrade-readiness:readiness-generate` |
