...
Document chain:
  - Related ADRs: [list or "None - consider /toque:documentation adr {topic}"]
  - Related PRDs: [list or "None - consider /toque:documentation prd {feature}"]
  - Related BRDs: [list or "None - consider /toque:documentation brd {domain}"]
