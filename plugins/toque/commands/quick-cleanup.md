...
- "If you want to build something with this data, run /toque:plan {name} to continue."
</plan_homebase>
...
- `/toque:quick-plan "{topic} integration"` (if implementation needed)
- `/toque:documentation spec {topic}` (if a technical spec is needed)
- `/toque:documentation adr {topic}` (if an architectural decision is needed)
```
