...
# DeepGrade Readiness Guide v9.0.0
...
> A reference for the deepgrade-readiness plugin: AI-readiness scanning with a composite letter grade.

DeepGrade Readiness scores how well an AI coding agent can read, navigate, and
...
four DeepGrade plugins; `deepgrade-audit` picks up where the readiness grade
leaves off.

## Commands

### `/deepgrade-readiness:readiness-scan`
...
### `/deepgrade-readiness:readiness-generate`
...
**Example:**
```
/deepgrade-readiness:readiness-generate all-critical
```
...
/plugin update deepgrade-readiness
/reload-plugins
/plugin list
```
...
> ```bash
> claude --plugin-dir /path/to/deepgrade/plugins/deepgrade-readiness
> ```
