...
Reference the `deepgrade-readiness:readiness-scoring` skill for which checks a generated artifact actually moves, and by how much.
...
tell the user to run /deepgrade-readiness:readiness-scan first.
</context>
...
- Reminder to run /deepgrade-readiness:readiness-scan to verify improvement
</workflow>
...
- After generating, remind user to re-scan with /deepgrade-readiness:readiness-scan.
</constraints>
