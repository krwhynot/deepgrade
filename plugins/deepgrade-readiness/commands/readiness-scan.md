...
Reference the `deepgrade-readiness:readiness-scoring` skill for gate thresholds, confidence levels and grading criteria.
...
Tell the user they can run /deepgrade-readiness:readiness-generate to create missing artifacts.
</workflow>
...
When running /deepgrade-audit:codebase-audit, these areas should receive
