...
Run `/deepgrade-readiness:readiness-generate [number]` to create any of these:
...
Run `/deepgrade-readiness:readiness-generate all-critical` to generate all critical missing artifacts.
Run `/deepgrade-readiness:readiness-scan` again after making changes to measure improvement.
