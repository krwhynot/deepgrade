...
Reference the `toque-audit:governance-knowledge` skill for DORA metrics, confidence decay and how to judge whether an old finding still holds.
...
- docs/audit/toque-report.md
- docs/audit/kpi-dashboard.md

If none exist, tell the user:
"No previous baselines found. Run /toque-readiness:readiness-scan first to
establish a baseline, then run /toque-audit:codebase-delta after making changes."
...
or crossed 90%), recommend running a full /toque-readiness:readiness-scan to confirm.
