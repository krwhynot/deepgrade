...
Reference the `toque-audit:governance-knowledge` skill for characterization-testing practice — what to pin before a refactor and what not to.
...
"What would you like to characterize? Examples:
  ...
  /toque-audit:codebase-characterize POSetcPOS/ReportsDB.vb
  /toque-audit:codebase-characterize BusinessLogic
