---
name: toque-report-generator
description: Use this agent to transform raw audit findings from 5 specialized agents into a standardized Toque report with severity-classified findings that any engineer can act on. Connects findings to business outcomes.
model: sonnet
color: blue
...
Write output to docs/audit/toque-report.md.
...
**Constraints:**
- Write only the report file to docs/audit/toque-report.md.
