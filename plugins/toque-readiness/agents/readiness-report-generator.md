...
Run `/toque-readiness:readiness-generate [number]` to create any of these:
...
Run `/toque-readiness:readiness-generate all-critical` to generate all critical missing artifacts.
Run `/toque-readiness:readiness-scan` again after making changes to measure improvement.
