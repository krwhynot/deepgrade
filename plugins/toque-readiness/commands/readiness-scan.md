...
Reference the `toque-readiness:readiness-scoring` skill for gate thresholds, confidence levels and grading criteria.
...
Tell the user they can run /toque-readiness:readiness-generate to create missing artifacts.
</workflow>
...
When running /toque-audit:codebase-audit, these areas should receive
