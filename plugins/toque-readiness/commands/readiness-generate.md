...
tell the user to run /toque-readiness:readiness-scan first.
</context>
...
- Reminder to run /toque-readiness:readiness-scan to verify improvement
</workflow>
...
- After generating, remind user to re-scan with /toque-readiness:readiness-scan.
</constraints>
