...
`toque-audit` for deeper code-quality audits once readiness is in shape.
...
| Command | Description |
| ------- | ----------- |
| `/toque-readiness:readiness-scan` | AI readiness scan (52 checks, 9 categories, letter grade) |
| `/toque-readiness:readiness-generate` | Generate the missing artifacts the scan found |
