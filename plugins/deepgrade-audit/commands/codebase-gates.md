...
Reference the `deepgrade-audit:governance-knowledge` skill for quality-gate thresholds and what belongs in CI versus a local hook.
...
"Quality gates require Phase 2 audit data. Run /deepgrade-audit:codebase-audit
first, then run /deepgrade-audit:codebase-gates to generate automated checks."
...
LAYER 2: Smart Nudges (when these trigger)
  - After {N} file changes: "Consider running /deepgrade-audit:codebase-delta"
  - Config/migration file changed: "Baseline may be stale. Run /deepgrade-audit:codebase-security?"
  - HIGH-risk module touched: "Run /deepgrade-audit:codebase-characterize before changing this"
  - {N} days since last audit: "Last audit was X days ago"
  - Plan PR merged: "Update baselines with /deepgrade-audit:codebase-delta?"
...
- Re-run /deepgrade-audit:codebase-gates after a new audit to update thresholds.
