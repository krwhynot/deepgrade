...
Reference the `deepgrade-audit:governance-knowledge` skill for characterization-testing practice — what to pin before a refactor and what not to.
...
"What would you like to characterize? Examples:
  ...
  /deepgrade-audit:codebase-characterize POSetcPOS/ReportsDB.vb
  /deepgrade-audit:codebase-characterize BusinessLogic
