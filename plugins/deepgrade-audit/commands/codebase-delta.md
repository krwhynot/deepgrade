...
Reference the `deepgrade-audit:governance-knowledge` skill for DORA metrics, confidence decay and how to judge whether an old finding still holds.
...
"No previous baselines found. Run /deepgrade-readiness:readiness-scan first to
establish a baseline, then run /deepgrade-audit:codebase-delta after making changes."
...
or crossed 90%), recommend running a full /deepgrade-readiness:readiness-scan to confirm.
