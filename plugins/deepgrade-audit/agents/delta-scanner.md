...
description: |
  ...
  Called by the /deepgrade-audit:codebase-delta command.
model: sonnet
color: green
...
/deepgrade-readiness:readiness-scan first to establish a baseline."
...
report the previous score and note that a full /deepgrade-readiness:readiness-scan is
...
- If you need exact readiness score, tell the user to run /deepgrade-readiness:readiness-scan.
